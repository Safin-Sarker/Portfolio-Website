...
const projects = [
  {
    title: 'Fletchy',
    description: 'A Modern E-commerce application using ASP.NET Core API, React, and AI. Features include product management, shopping cart, payment integration, and AI-powered recommendations.',
  ...
  },
  {
    ...
    description: "Master's thesis project focused on developing an AI-powered image generation system using Stable Diffusion and ComfyUI to enhance design workflows for medical illustrations.",
    technologies: ['Stable Diffusion', 'ComfyUI', 'Python', 'LoRA', 'Prompt Engineering'],
    github: 'https://github.com/Safin-Sarker/Stable-Diffusion-ComfyUI',
    featured: true,
  },
  {
    title: 'DevPost Blog Website',
    description: 'A comprehensive blogging platform built with ASP.NET Core MVC, featuring user authentication, post management, comments, and a clean, modern interface.',
    technologies: ['ASP.NET Core MVC', 'Entity Framework', 'MSSQL', 'Bootstrap', 'jQuery'],
    github: 'https://github.com/Safin-Sarker/DevPost',
    featured: true,
  },
  {
    title: 'Easy Inventory Management System',
    description: 'A full-featured inventory management system with real-time tracking, stock management, supplier management, and reporting capabilities.',
    technologies: ['ASP.NET Core MVC', 'Entity Framework', 'MSSQL', 'JavaScript'],
    github: 'https://github.com/Safin-Sarker/Easy-Inventory-System',
  },
  {
    title: 'JSON Serializer',
    description: 'A custom JSON serializer implementation using recursion and reflection in C#, demonstrating deep understanding of .NET internals and data structures.',
    technologies: ['C#', 'Reflection', 'Recursion', '.NET Core'],
    github: 'https://github.com/Safin-Sarker/Json-Serializer',
  },
  {
    title: 'Data Science Projects',
    description: 'Collection of data science and machine learning projects using Jupyter notebooks, including data analysis, visualization, and predictive modeling.',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 text-center mb-12 max-w-2xl mx-auto">
            A showcase of my work spanning full-stack development, AI/ML, and software architecture
          </p>
