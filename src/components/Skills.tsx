...
const aiSkillCategories = [
  {
    ...
    skills: ['Stable Diffusion', 'LoRA Fine-tuning', 'Train LLM in LoRA', 'ComfyUI', 'RAG (Retrieval Augmented Generation)', 'LangChain', 'Ollama', 'ChromaDB', 'Pinecone', 'Vector Embeddings', 'Prompt Engineering'],
  },
  {
