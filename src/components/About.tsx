              ...
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 p-1 rounded-2xl">
                <div className="bg-gray-100 dark:bg-gray-800 p-8 rounded-2xl">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    Full Stack Developer and AI Engineer with expertise in
                    building intelligent, scalable software solutions.
                    Specialized in generative AI technologies including Stable
                    Diffusion, LoRA fine-tuning, and RAG (Retrieval Augmented
                    Generation) systems, while maintaining strong full-stack
                    development capabilities across modern web technologies and
                    cloud platforms.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
                    Passionate about bridging the gap between traditional
                    software engineering and cutting-edge AI/ML applications.
                    Experienced in developing AI-powered applications,
                    implementing DevOps practices, and creating production-ready
                    solutions that leverage both classical software architecture
